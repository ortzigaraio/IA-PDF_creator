...
def generar_excel_consolidado_equipo(equipo_datos: list, empresa_id: str):
    ...
    ws_rank.add_image(img_rank, f"A{start_img_row}")
    ...
    ws_heat.add_image(img_heat, f"A{heat_start_row}")
