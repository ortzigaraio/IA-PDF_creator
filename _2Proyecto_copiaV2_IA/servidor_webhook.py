...
from motor_prisma import MotorPrismaHRv2, UsuarioData, generar_radar_base64
import jinja2
...
app = FastAPI(title="PrismaHR Webhook IA v2.0")

# API KEY Placeholder (Debería venir de env vars)
API_KEY = os.getenv("GROQ_API_KEY")
if not API_KEY:
    raise ValueError("Falta la variable de entorno GROQ_API_KEY")
motor = MotorPrismaHRv2(API_KEY, "diccionario_perfiles.json")
...
if __name__ == "__main__":
    print("🚀 Iniciando Servidor Webhook PrismaHR v2.0...")
